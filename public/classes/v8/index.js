...
var _furioosServerUrl = "https://portal.furioos.com";
...
// const player = new Player("NyAmo7vmc3Cyhky9B", "furioos_container", {
const player = new Player("xpfhHZbKA6mxN5ro5", "furioos_container", {
  whiteLabel: true,
  hideTitle: true,
  hideToolbar: false,
...
//overridedURL: 'http://localhost:5500'
let value = 1;
...
player.onSDKMessage(function (data) {
  ...
  arr.push(data);
  var image = new Image();
  var image1080 = new Image();
  image.src = "data:image/png;base64," + arr[0];
  if (arr.length > 1) {
    image1080.src = "data:image/png;base64," + arr[1];
    document.getElementById("download1080").href = image1080.src;
  }
  console.log("now data is ", arr);
  image.style.width = "100%";
  image.style.height = "100%";

  document.getElementById("captureImg").innerHTML = "";
  document.getElementById("captureImg").appendChild(image);
